...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [616913.215441, 6876995.633997, 664155.160682, 6915669.932924], maxZoom: 18, minZoom: 1
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([616913.215441, 6876995.633997, 664155.160682, 6915669.932924], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Protestantse Gemeente Dronten</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (122 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Klik op het vergrootglas, geef een adres op en selecteer het goede adres.<br />Klik op de kaart voor informatie over het adres.';
            }
