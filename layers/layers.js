...
lyr_Kwartierindeling_1.set('fieldAliases', {'id': 'id', 'Kwartier': 'Kwartier', });
lyr_Kwartierindeling_1.set('fieldImages', {'id': 'TextEdit', 'Kwartier': 'TextEdit', });
lyr_Kwartierindeling_1.set('fieldLabels', {'id': 'hidden field', 'Kwartier': 'inline label - always visible', });
